...
var _weatherapi = require("./Weatherapi");
var _forccast = require("./Forccast");
var _city = require("./city");
(0, _body.renderBody)();
(0, _city.global)(); // if (!globalCity) {
 //   alert('Please enter a city');
 // } else {
 //   global();
 // }

},{"./body":"e3ZDK","./Weatherapi":"6egSn","./Forccast":"OBXgr","./city":"alcnd"}],"e3ZDK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderBody", ()=>renderBody);
parcelHelpers.export(exports, "imgContainer", ()=>imgContainer);
...
},{"./body":"e3ZDK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"OBXgr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "weatherForcast", ()=>weatherForcast);
parcelHelpers.export(exports, "displayforcast", ()=>displayforcast);
var _weatherapi = require("./Weatherapi");
var _city = require("./city");
var _renderData = require("./renderData");
const weatherForcast = async function(x) {
    if (!x) alert("city is missing");
    try {
        const res = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=${(0, _weatherapi.API_KEY)}&q=${x}&days=4&aqi=no&lang=fr,`);
        const data = await res.json();
...
const displayforcast = async function(x) {
...
const global = function() {
    window.addEventListener("load", ()=>{
        ...
        btn.addEventListener("click", (e)=>{
            ...
            (0, _forccast.displayforcast)(city);
        });
    });
};
const temp = function() {
...
},{"./Forccast":"OBXgr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7AByM":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequirebbde")
